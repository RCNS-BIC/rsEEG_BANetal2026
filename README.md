...
The pipeline is conducted in Automatic Analysis (aa; version 5.8.1; ), runs on MATLAB (version 2024b, The Mathworks Inc., 2024) and utilises EEGLab (version 2024.2), and FieldTrip (git revision 2755b10) functionalities. 
For details on each step, see the manuscript above.
